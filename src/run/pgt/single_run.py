...
if __name__ == "__main__":
    ...
    with open("configs/pgt/england/perm_equiv_gncde_config.yaml", "r") as file:
        config_yaml = yaml.safe_load(file)

    if config_yaml["model"]["name"] in ["astgcn", "dcrnn", "stid_gcn"]:
        from engine.trainer_recurrent_pgt import Trainer
    else:
        from engine.trainer_pgt import Trainer
