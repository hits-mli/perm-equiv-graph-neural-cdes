...
from .layers import ConvEquivFusionLayer
from ..neural_nets import IdxEncoder


class PermEquivGraphVectorField(eqx.Module):
    gnn_layers: list[ConvEquivFusionLayer]
    data_embed_dim: int
    num_nodes: int
    # idx_enc: IdxEncoder
    # msg_func_adj: eqx.nn.MLP | eqx.nn.Linear
    # msg_func_adj_deriv: eqx.nn.MLP | eqx.nn.Linear
    enc_idx: bool
